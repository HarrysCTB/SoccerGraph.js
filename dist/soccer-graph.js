(function (global, factory) {
    ...
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.soccerGraph = {}));
    ...
    class BubbleGraph extends BaseGraph {
        ...
        setup() {
            // Crée les échelles et configurations
            this.fullWidth = 1133;
            this.fullHeight = 755;
            ...
            this.xScale = linear().domain([0, 100]).range([this.margin.left, this.fullWidth - this.margin.right]);
            this.yScale = linear().domain([0, 100]).range([this.fullHeight - this.margin.bottom, this.margin.top]);
            this.radiusScale = quantize()
                .domain([0.001, 1])
                .range(range(4, 15));

            // Configurer le SVG
            this.svg = select(this.svgElement)
                .attr('viewBox', `566 0 ${this.width} ${this.height}`)
                .attr('preserveAspectRatio', 'xMidYMid meet');

            this.svg.append("image")
                .attr("href", "/Football_pitch_horizontal.svg")
        ...
        destroy() {
            super.destroy();  // Clear SVG using BaseGraph's destroy
        }
    }
